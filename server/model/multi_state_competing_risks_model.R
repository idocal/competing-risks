...
MultiStateModel$methods(
  ...
  fit_state_specific_model = function(state, competing_risks_dataset, covariate_names_ = covariate_names) {
    ...
    model$fit(t_transition, target_state, covariates_X, sample_ids = id, t_start=t_entry, sample_weights = weights)
...
# ---------------------------------------------------------------
#
#   Temporary, specific implementation for our case. 
#
# ---------------------------------------------------------------
